...
updated_cfg=$(echo "$current_cfg" | sed 's/\"host\": \"192.168.61.29:27017\", \"priority\": [0-9]\.\?[0-9]*\/\1\"priority\": 2/' | sed 's/\"host\": \"192.168.61.66:27016\", \"priority\": [0-9]\.\?[0-9]*\/\1\"priority\": 1/')
